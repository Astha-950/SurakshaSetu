...
export const addMessageToChat = async (req, res) => {
  try {
    ...
    const predefinedQA = [
      { input: "hello", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "hi", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "hey", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "helo", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "hi there", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "good morning", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },
  { input: "good evening", output: "Hello! Welcome to Suraksha setu. I am your assistant. How can I help you today?" },

  // ABOUT Suraksha setu
  { input: "what is Suraksha setu", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },
  { input: "tell me about Suraksha setu", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },
  { input: "whats Suraksha setu", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },
  { input: "Suraksha setu info", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },
  { input: "explain Suraksha setu", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },
  { input: "platform overview", output: "Suraksha setu is a platform designed to connect users who need help with NGOs ready to offer support. You can post issues, read blogs, access helplines, and more." },

  // USING PLATFORM
  { input: "how can i use Suraksha setu", output: "You can create posts, browse blogs, access helplines, and connect with NGOs through Suraksha setu." },
  { input: "how do i use this platform", output: "You can create posts, browse blogs, access helplines, and connect with NGOs through Suraksha setu." },
  { input: "how to use Suraksha setu", output: "You can create posts, browse blogs, access helplines, and connect with NGOs through Suraksha setu." },
  { input: "what can i do here", output: "You can create posts, get help from NGOs, read useful blogs, and explore helplines on Suraksha setu." },
  { input: "what features are available", output: "You can create posts, get help from NGOs, read useful blogs, and explore helplines on Suraksha setu." },
  { input: "what are the main services", output: "You can create posts, get help from NGOs, read useful blogs, and explore helplines on Suraksha setu." },
  { input: "is it free to use", output: "Yes, Suraksha setu is completely free for users." },
  { input: "does it cost anything", output: "No, using Suraksha setu is free." },
  { input: "do i have to pay", output: "No, using Suraksha setu is free." },
  ...
  // UNIQUENESS / TRUST
  { input: "what makes Suraksha setu different", output: "Our commitment to transparency and building trust makes us unique. We stay with you until your problem is resolved." },
  { input: "why should i use Suraksha setu", output: "Because we are transparent, committed to your journey, and make sure your problem doesn't get ignored." },
  { input: "what is unique about Suraksha setu", output: "Transparency, trust, and continuous support until a conclusion is reached make Suraksha setu special." },
  ...
  { input: "is Suraksha setu open to all ngos", output: "Yes, any verified NGO focused on social good can join Suraksha setu." },
  ...
  { input: "how to use Suraksha setu", output: "You can explore posts, create your own post, read blogs, and access helplines. Simply sign up and get started!" },
  ...
  { input: "how can Suraksha setu help me", output: "Suraksha setu connects you with NGOs who are willing to help you based on your needs." },
  { input: "is Suraksha setu free", output: "Yes! Suraksha setu is completely free to use for users and NGOs." },
  ...
  { input: "what are blogs in Suraksha setu", output: "Blogs are informative articles you can read about rights, opportunities, NGOs, and helpful tips." },
  { input: "where to find helplines", output: "You can find helplines listed under the 'Helpline' section in Suraksha setu's menu." },
  ...
  { input: "how can ngos join", output: "NGOs can register on Suraksha setu, verify their identity, and start helping users directly through posts." },
  { input: "do ngos get credit", output: "Yes, NGOs and organizations that solve issues will receive public credit and appreciation!" },
  { input: "how Suraksha setu track ngos", output: "We track post statuses. If a post remains unresolved for over a month, we follow up with the NGO directly." },
  { input: "what if ngos ignore", output: "If an NGO ignores a problem, Suraksha setu will step in to contact them and inform the user transparently." },
  ...
  { input: "how Suraksha setu builds trust", output: "We ensure transparency by tracking every post, following up with NGOs, and keeping users updated." },
  ...
  { input: "what makes Suraksha setu different", output: "Our mission is not just to post and forget. We stay in touch with users till we reach a conclusion." },
  { input: "what is unique about Suraksha setu", output: "Transparency, trust, and dedication to solving every problem till the end makes us unique!" },
  { input: "is Suraksha setu safe", output: "Yes, we ensure safety, privacy, and transparency for every user and NGO on the platform." },

  // GENERAL SUPPORT
  { input: "i have a doubt", output: "Feel free to ask! I'm here to help you understand everything about Suraksha setu." },
  { input: "who are you", output: "I am your Suraksha setu Assistant. I'm here to guide you through the platform and help you connect with NGOs." },
  { input: "how to contact Suraksha setu team", output: "You can use the 'Contact Us' section to reach our support team directly." },
  ...
  { input: "can i donate", output: "Yes, some NGOs on Suraksha setu accept donations. We will guide you safely to trusted channels." },
  { input: "is Suraksha setu government site", output: "No, Suraksha setu is an independent platform aimed at connecting help seekers and NGOs transparently." },
  ...
  { input: "what languages Suraksha setu support", output: "Currently, Suraksha setu primarily supports English, but multi-language support is coming soon!" },
  { input: "where is Suraksha setu available", output: "Suraksha setu is accessible online from anywhere, but currently focused mainly on Indian NGOs and users." },
  ...
  { input: "what is verified user", output: "Verified users have passed basic identity verification to keep Suraksha setu safe and genuine." },
  { input: "what is Suraksha setu", output: "Suraksha setu is a platform built to bridge the gap between NGOs and people who need help. We make it easy for users to connect with organizations and get support." },
  { input: "tell me about Suraksha setu", output: "Suraksha setu is a centralized platform where users can post problems, access helplines, read blogs, and get connected to NGOs ready to help." },
  { input: "who created Suraksha setu", output: "Suraksha setu was created with the vision of making help accessible, trustworthy, and transparent for everyone in need." },
  ...
  { input: "what all can be done on Suraksha setu", output: "You can read blogs, create posts, stay anonymous while posting, access helplines, and connect directly to NGOs for support." },
  ...
  { input: "is Suraksha setu for everyone", output: "Yes, Suraksha setu is open for anyone who genuinely needs help or wants to contribute through NGOs." },
  ...
  { input: "how do ngos respond", output: "NGOs see your post, evaluate it, and reach out to you either through Suraksha setu or their contact channels." },
  ...
  { input: "what makes Suraksha setu different", output: "Our focus is on building trust and transparency. We stay with the user until their problem is solved, unlike other platforms." },
  ...
  { input: "will Suraksha setu support me until the end", output: "Yes, we stay in touch until your issue is either solved or a clear update is provided. You're never left alone." },
